    ...
    const std::uint32_t pack_src_format, const std::uint32_t pack_dst_format, const std::uint32_t face_r_dim = FACE_R_DIM, const std::uint32_t num_faces = 4)
{
    ...
    llk_san::operation_init<llk_san::operation_t::PackUntilize>(block_ct_dim, full_ct_dim, narrow_row);
    ...
    const std::uint32_t tile_dst_rt_offset          = 0)
{
    ...
    llk_san::operation_check<llk_san::operation_t::PackUntilize>(block_ct_dim, full_ct_dim, narrow_row);
